 ...
 * 
 * Run with: node scripts/test-ideas-feature.mjs <show_id>
 * Example: node scripts/test-ideas-feature.mjs a7982c70-2b0e-46af-a0ad-c78f4f69cd56
 */
...
// Load .env.local or .env file manually BEFORE importing modules that need env vars
function loadEnv() {
...
// CRITICAL: Load env vars synchronously before any imports
loadEnv();
...
import { getLearnedAdjustments, applyLearnedAdjustments } from '../lib/learning/signalEffectiveness.js';
...
if (!showId) {
  ...
  console.error('   node scripts/test-ideas-feature.mjs <show_id>');
