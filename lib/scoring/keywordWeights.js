...
export function calculateMatchScore(matchedKeywords, excludedNames = []) {
  ...
  // NEW: Require topic-specific keywords for match
  // Topic-specific keywords (high value, indicate actual topic)
  const TOPIC_SPECIFIC_KEYWORDS = new Set([
    // Finance
    'credit', 'card', 'bank', 'rate', 'stock', 'bond', 'inflation', 'fed', 'federal reserve',
    'interest', 'borrower', 'debt', 'dollar',
    // Tech
    'tesla', 'ai', 'self-driving', 'autonomous', 'chip', 'nvidia', 'openai', 'chatgpt', 'gpt',
    // Energy
    'oil', 'gas', 'opec', 'pipeline', 'lng', 'barrel', 'petroleum', 'crude',
    // Geopolitics (specific)
    'greenland', 'venezuela', 'ukraine', 'nato', 'sanctions', 'invasion', 'syria', 'lebanon',
    // Arabic equivalents
    'نفط', 'غاز', 'أسهم', 'بنك', 'تسلا', 'فنزويلا', 'أوكرانيا', 'عقوبات', 'سوريا', 'لبنان',
    'اقتصاد', 'تضخم', 'دولار', 'قرض', 'دين'
  ]);
