  ...
  if (keywordMatches && keywordMatches.length > 0) {
   ...
   // Reject if signal is clearly about one domain but matched to another
    ...
    const domainMismatches = [
        // Entertainment -> geopolitics mismatches
        {
        ...
        // Rentals/Tourism/Lifestyle -> EV/Automotive
        {
          signalKeywords: ['rental', 'rentals', 'rent', 'hire', 'إيجار', 'تأجير', 'tourism', 'سياحة', 'hotel', 'فندق', 'luxury lifestyle', 'travel'],
          wrongTopics: ['ev_automotive', 'electric_vehicle', 'ev'],
          reason: 'Rental/tourism signal matched to EV/Automotive'
        },
        // Generic business -> EV/Automotive (unless about EV companies)
        {
          signalKeywords: ['real estate', 'عقارات', 'restaurant', 'مطعم', 'retail', 'تجزئة', 'mall', 'مول'],
          wrongTopics: ['ev_automotive', 'electric_vehicle'],
          reason: 'Generic business signal matched to EV/Automotive'
        }
      ];
